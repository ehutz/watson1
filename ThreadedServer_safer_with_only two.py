...
#        while count < 4:
		...
		client_name[count] = client
		count = count + 1
        threading.Thread(target = self.listenToClients,args = (client_name[1], client_address[1], client_name[2], client_address[2], 1)).start()
        threading.Thread(target = self.listenToClients,args = (client_name[1], client_address[1], client_name[2], client_address[2], 2)).start()
